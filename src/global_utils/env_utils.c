...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/19 16:46:22 by Curro TLP         #+#    #+#             */
/*   Updated: 2026/01/19 16:46:22 by Curro TLP        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_lst_env_init(t_env **env, char **envp)
{
	...
	/* ensure the list head is initialized to NULL to avoid reading uninitialized memory */
	if (env)
		*env = NULL;
	i = -1;
